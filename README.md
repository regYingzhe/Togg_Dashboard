...
### How to set up GCP cloud server
- Go to NETWORKING Tab -> VPC network -> Firewall rules 
- Click EDIT, then add 9020 at protocols and ports, Specified protocols and ports blank. tcp:9020>
